  ...
  const features = [
    {
      ...
      description:
        "Set up recurring payments with UPI AutoPay/E-NACH for hassle-free collection",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Automatic notifications and reminders for due payments via SMS and email",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Track payment history, pending dues, and collection efficiency in real-time",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Easy Digital Receipts",
      description:
        "Generate and download payment receipts instantly for every transaction",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Support for UPI, credit/debit cards, net banking and more payment methods",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Get insights on collection efficiency, payment trends and defaulter patterns",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
