    ...
    const commonActions = [
      {
        ...
        onClick: () => {
          ...
          doc.text(
            "This is a sample report generated from Quick Actions.",
            10,
            20
          );
          ...
          toast({
            ...
            description: "Your quick report has been downloaded.",
          });
        },
      },
      {
          ...
          },
          {
            ...
            onClick: () =>
              toast({
                ...
                description: "New exam has been scheduled.",
              }),
          },
          ...commonActions,
        ];
        ...
        return [
          ...
          },
          {
            ...
            onClick: () =>
              toast({
                title: "Results",
                description: "Opening results dashboard.",
              }),
          },
        ];
        ...
        return [
          {
            ...
            onClick: () =>
              toast({
                title: "Add Institute",
                description: "Opening institute registration form.",
              }),
          },
          {
            id: "bulk-upload",
